...
public partial class MainWindow
{
    private void About_Click(object sender, RoutedEventArgs e)
    {
        ...
        var help = "JST PLC Finder 1.1\n\n" +
            ...
            "Taskbar mode can refresh detected PLCs on its own interval (Settings > Taskbar). When a PLC that was online stops responding after a taskbar refresh, Windows shows an offline notification once; another notification is sent only if it returns online and goes offline again. Automatic scans in Taskbar mode show one notification listing all newly discovered network devices.\n\n" +
